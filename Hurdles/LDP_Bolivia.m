function [REWS,REWS_f,REWS_b]  = LDP_Bolivia(time,isValid,beamID,lineOfSightWindSpeed,DT,LDP)
...
% smoothing
lineOfSightWindSpeed = smoothdata(lineOfSightWindSpeed,"movmean",1075);
