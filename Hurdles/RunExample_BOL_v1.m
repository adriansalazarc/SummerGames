...
% select LDP function
MyLDPfunction       = @LDP_BOL_v2; % [LDP_v3/LDP_BOL_v1]
...
for iSeed = 1:nSeed    
    ...
    % 
    REWS_mov = smoothdata(REWS,"movmean",1280);
    ...
    Error                               = REWS_WindField_shifted-REWS_mov;                    % error is  REWS from wind field shifted minus REWS from lidar filtered and buffered.
...
Cost                        = mean(MAE);
fprintf('Cost for Summer Games 2025 ("18 m/s hurdles"):  %f, n_moving_average = %d\n',Cost,n_moving);
